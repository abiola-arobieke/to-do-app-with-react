...
<div align="center">
  <h3><b>To-do App With-React README</b></h3>
</div>
...
# 📖 [To-do App With-React} <a name="about-project"></a>

**To-do App With-React** is a simple project to create a list of to-do activities.
...
- **Edit and save a task to the local storage**
...
```sh
  git clone https://github.com/abiola-arobieke/to-do-app-with-react.git
```
...
- [ ] **Add Navigation bar and home page**
- [ ] **Add calender and reminder**
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/to-do-app-with-react/issues).
